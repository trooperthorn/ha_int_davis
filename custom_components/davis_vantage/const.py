...
SERVICE_GET_STATION_TYPE = 'get_station_type'
SERVICE_RXTEST = 'rxtest'
SERVICE_GET_RECEIVERS = 'get_receivers'
SERVICE_GET_CALIBRATED_VALUES = 'get_calibrated_values'
SERVICE_SET_CALIBRATED_VALUES = 'set_calibrated_values'
SERVICE_SET_YEARLY_ET = 'set_yearly_et'
